...
public class Constants {
    ...
    */
    ...
    public static int MIN_AIMING_ARROW_LENGTH = 150;
    public static int MAX_AIMING_ARROW_LENGTH = 300;
    ...
    public static int AIMING_ARROW_LENGTH_INCREMENT = (MAX_AIMING_ARROW_LENGTH - MIN_AIMING_ARROW_LENGTH) / MAX_ATTRIBUTE;
